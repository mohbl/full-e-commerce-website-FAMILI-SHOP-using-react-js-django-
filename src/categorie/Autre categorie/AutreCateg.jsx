...
const AutreCateg = () => {
  ...
  const [products, setProducts] = useState([]); // Moved the state declaration to the top
  ...
  const handleFilter = async () => {
    try {
      const response = await axios.get('https://familishop.onrender.com/products/collection/' + sousCategorie + '/?gender=M&min_price=' + min + '&max_price=' + max);
  ...
  return (
    <div className="PageContainer p-3 bg-[#E3E2E2]/40 ">
      <h1 className="text-[#8A8888] font-semibold text-lg mx-3 mb-2 "> Categories <span> &gt; </span> <span className="text-[#800B8D]"> {sousCategorie} </span></h1>
